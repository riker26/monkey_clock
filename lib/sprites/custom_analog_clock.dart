...
import 'package:monkey_clock/sprites/custom_analog_clock_painter.dart';
...
class CustomAnalogClock extends StatefulWidget {
  ...
  final double width;
  final double height;
  final double minuteHandLengthMultiplier;
  final double secondHandLengthMultiplier;
  final double hourHandLengthMultiplier;
  ...
  const CustomAnalogClock(
      ...
      this.hourHandLengthMultiplier = 1.0,
      this.minuteHandLengthMultiplier = 1.0,
      this.secondHandLengthMultiplier = 1.0,
  ...
  @override
  _CustomAnalogClockState createState() => _CustomAnalogClockState(datetime);
}
...
class _CustomAnalogClockState extends State<CustomAnalogClock> {
  ...
  _CustomAnalogClockState(datetime)
          ...
          child: AspectRatio(
              ...
              child: new Container(
                  ...
                  child: new CustomPaint(
                    painter: new CustomAnalogClockPainter(
                        datetime: datetime,
                        ...
                        minuteHandLengthMultiplier:
                            widget.minuteHandLengthMultiplier,
                        secondHandLengthMultiplier:
                            widget.secondHandLengthMultiplier,
                        hourHandLengthMultiplier:
                            widget.hourHandLengthMultiplier,
  ...
  @override
  void didUpdateWidget(CustomAnalogClock oldWidget) {
